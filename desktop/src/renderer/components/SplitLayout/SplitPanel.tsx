 ...
 */
export function SplitPanel({ pane, projectId, isRoot = false }: SplitPanelProps) {
  // ═══════════════════════════════════════════════════════
  ...
  return (
    ...
    >
      <Allotment.Pane className={styles.pane}>
        <SplitPanel pane={firstChild} projectId={projectId} />
      </Allotment.Pane>
      <Allotment.Pane className={styles.pane}>
        <SplitPanel pane={secondChild} projectId={projectId} />
      </Allotment.Pane>
    </Allotment>
  )
}
